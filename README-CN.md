阿里云多区域双活容灾架构 Terraform 模块

[English](https://github.com/alibabacloud-automation/terraform-alicloud-multi-region-active-active-disaster-recovery/blob/main/README.md) | 简体中文
...
如果您在使用该 Terraform 模块的过程中有任何问题，可以通过以下方式联系我们：

* 在 Terraform Provider 的 [Github 仓库](https://github.com/aliyun/terraform-provider-alicloud/issues/new)提交 issue
* 提交 issue 请参考 [提交issue](https://github.com/aliyun/terraform-provider-alicloud/blob/master/README_zh.md#%E6%8F%90%E4%BA%A4issue)

**注意：**不建议在 provider issue 中添加自制标签（如 bug、new 等），Terraform provider 官方会添加相应标签。
