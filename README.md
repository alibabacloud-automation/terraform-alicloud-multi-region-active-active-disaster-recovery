...
This Terraform module creates a comprehensive [multi-region active-active disaster recovery architecture](https://www.alibabacloud.com/help/doc-detail/146504.htm) on Alibaba Cloud, including VPCs, ECS instances, PolarDB clusters, ALB load balancers, and cross-region connectivity through CEN (Cloud Enterprise Network) for high availability and business continuity.
...
module "disaster_recovery" {
  ...
  # Region A vswitch configurations
  ...
  # Region B vswitch configurations
